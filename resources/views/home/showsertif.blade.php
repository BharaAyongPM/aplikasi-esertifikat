...
<main>
                ...
                <div class="text-white align-items-start">
                    ...
                    <div class="col-md-6 mx-auto text-start">
                        ...
                        <div class="text-center">
                            <a href="{{ route('kegiatan.downloadCertificate', $certificate->id) }}" class="btn btn-danger"><i class="fas fa-download me-2"></i>Unduh Sertifikat</a>
                        </div>
                    </div>
    ...
    <!-- Link untuk mengunduh sertifikat dalam bentuk PDF -->
