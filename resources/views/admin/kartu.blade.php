                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block ">
                                <br><br>
                                <img src="{{ asset('admin/img/bisabola.png') }}"style="width: auto ; height: 250px;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">LOGIN CETAK KARTU</h1>
                                    </div>
                                    @if ($errors->any())
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.html">FORM CETA KARTU PEMAIN BISABOLA</a>
                                    </div>
